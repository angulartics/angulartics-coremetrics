...
* **angulartics Version(s)** - is it a regression?
* **angulartics-coremetrics Version(s)** - specific to this filter
...
* Search [GitHub](https://github.com/angulartics/angulartics-coremetrics/pulls) for an open or closed PR
...
* In GitHub, send a pull request to `angulartics-coremetrics:master`.
...
[stackoverflow]: http://stackoverflow.com/questions/tagged/angulartics-coremetrics